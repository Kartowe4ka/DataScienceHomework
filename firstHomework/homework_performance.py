...
# - Какие операции выполняются на GPU быстрее всего?
# Быстрее всего на GPU выполняет матричное умножение

# - Почему некоторые операции на GPU выполняются медленнее?
# Некоторые несложные операции выгодно выполнять на CPU, так как в таком случае GPU работает медленнее из-за
# перемещения данных
...
# Во время передачи данных между CPU и GPU тратиться существенная часть времени, которая при некоторых ситуациях может
# нивелировать сэкономленное время при использовании GPU
